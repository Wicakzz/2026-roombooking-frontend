                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <button
                      disabled={!isEditing}
                      onClick={() =>
                        setEditData({ ...editData, status: "Available" })
                      }
                    ...
                    <button
                      disabled={!isEditing}
                      onClick={() =>
                        setEditData({ ...editData, status: "Maintenance" })
                      }
                      className={`p-5 rounded-[2rem] border-2 transition-all flex flex-col items-center gap-2 ${
                ...
                bookings.map((b: any) => (
                  ...
                  >
                    <div className="flex justify-between items-center">
                      <div>
                        <p className="font-black text-slate-800 group-hover:text-indigo-600 transition-colors leading-tight">
                          {b.userName}
                        </p>
